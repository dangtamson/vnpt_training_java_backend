...
@RestController
@RequestMapping("api/v1.0/public/data")
@CrossOrigin(origins = "*", allowedHeaders = "*")
public class DataPublicApi {
	...
	private final String PUBLIC = "pub";
	...
	public ResponseEntity<Object> get(
		...
		try {
			...
			String sProcName = dataConfig.getFUNCTIONNAME_PREFIX() +PUBLIC +   "_" + sFunc + "_" + sAction; 
